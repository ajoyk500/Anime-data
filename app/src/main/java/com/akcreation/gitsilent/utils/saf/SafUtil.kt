...
//        return uri.toString().startsWith("content://${FsUtils.getAuthorityOfUri()}/internal/PuppyGitRepos/PuppyGit-Data/saf/")
     ...
     * 例如 "content://com.akcreation.gitsilent.play.pro/internal/abc.txt"，对应 /storage/emulated/0/Android/com.akcreation.gitsilent.play.pro/files/PuppyGitRepos/abc.txt
